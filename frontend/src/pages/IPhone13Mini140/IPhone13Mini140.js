...
const IPhone13Mini140 = () => {
  ...
  return (
    <div className="iphone-13-mini-140">
      ...
      <DarkModeFalseTypingNo
        ...
        icon="/basil_location-outline.png"
...
export default IPhone13Mini140;
